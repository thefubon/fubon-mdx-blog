...
const Dropdown = () => {
  ...
  const VISIBLE_DURATION = 1000 // мс - как долго фон остается видимым до начала анимации исчезновения
  const HIDE_DELAY = 1000 // мс - общая задержка удаления элемента
